...
import (
	...
	colcommon "github.com/chaolihf/mind-cluster/component/npu-exporter/collector/common"
	"github.com/chaolihf/mind-cluster/component/npu-exporter/collector/config"
	"github.com/chaolihf/mind-cluster/component/npu-exporter/collector/container"
	_ "github.com/chaolihf/mind-cluster/component/npu-exporter/plugins/inputs/npu"
	"github.com/chaolihf/mind-cluster/component/npu-exporter/plugins/prom"
	"github.com/chaolihf/mind-cluster/component/npu-exporter/utils/logger"
	"github.com/chaolihf/mind-cluster/component/npu-exporter/versions"
)
...
const (
	...
	defaultLogFile          = "npu-exporter.log"
...
func NpuServer(server http.Server) {
	...
	case prometheusPlatform:
		prometheusProcss(server, wg, ctx, cancel)
...
func prometheusProcss(server http.Server, wg *sync.WaitGroup, ctx context.Context, cancel context.CancelFunc) {
	...
	wg.Add(1)
	go func() {
		startServe(server, ctx, cancel, reg)
		wg.Done()
	}()
}
